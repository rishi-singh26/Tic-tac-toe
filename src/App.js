...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      player: 1, //this toggels between player 1 and playesr 2
      play: 1, //this checks if the game is ON or OFF. if someone wins the game is turned OFF.
    ...
    this.playerChoiceBlack = this.playerChoiceBlack.bind(this);
    this.playerChoiceWhite = this.playerChoiceWhite.bind(this);
  }

  toggleNavbar = () => this.setState({ collapsed: !this.state.collapsed });
  toggleModal = () => this.setState({ modalClosed: !this.state.modalClosed });
  ...
  // resBoxContent = () => {
  //   if (this.state.draw) {
  //     return <h3>Match Draw.</h3>;
  //   } else if (!this.state.winner) {
  //     if (this.state.blackScore > this.state.whiteScore) {
  //       return <h3>Black Wins.</h3>;
  //     } else {
  //       return <h3>White Wins.</h3>;
  //     }
  //   } else {
  //     return <div></div>;
  //   }
    ...
    if (this.state.play === 0) {
      ...
      return (
        <div>
          ...
          <br />
          <div className="col-8 offset-2" id="res">
            {/* <this.resBoxContent /> */}
          </div>
        </div>
      );
      ...
      <div className="App">
        ...
        <div>
          ...
          <Modal
            ...
            className="className"
          >
            <ModalHeader toggle={this.toggleModal}>Who goes first?</ModalHeader>
            <ModalBody>
              <Button
                color="dark"
                onClick={this.playerChoiceBlack}
              ...
              <Button
                color="light"
                onClick={this.playerChoiceWhite}
